...
Diese Anleitung erklärt, wie du Cursor IDE für die WoltLab Plugin-Entwicklung einrichtest. Schritt für Schritt, einfach erklärt.

---

## 📥 Cursor installieren

**Falls du Cursor noch nicht hast:**

1. **Download:** https://cursor.sh/
2. Klicke auf "Download for [dein Betriebssystem]"
3. Installiere Cursor nach dem Download
4. Öffne Cursor

**💡 Tipp:** Cursor ist kostenlos und sehr benutzerfreundlich.
...
- Aktiviere die Terminal-Befehle in Cursor:
  1. Öffne Cursor
  2. Gehe zu: **Einstellungen** (Zahnrad-Symbol)
  3. Suche nach: "Shell Command"
  4. Aktiviere: "Install 'cursor' command"
- Oder verwende Option B

**Option B: Über das Cursor-Menü**
...
4. Falls sich nichts tut: Rechtsklick → "Öffnen mit" → Cursor
...
Cursor schlägt automatisch Extensions vor. Installiere diese:
...
- Cursor schlägt die Extension automatisch vor
- Klicke auf "Install"
...
1. Öffne die Datei `woltlab-plugin-dev.code-workspace` in Cursor
2. Bearbeite die `settings` Sektion
3. Speichere die Datei (`Ctrl + S` oder `Cmd + S`)
...
4. **Cursor komplett neustarten** (siehe Schritt 4)
...
2. **Prüfe die Cursor-Konsole für Fehler:**
...
5. **Terminal in Cursor:** Nutze das integrierte Terminal (`Ctrl + ~` oder `Cmd + ~`)
