/**
 * Renders QR codes for shortened URLs in the ACP link list.
 *
 * @author      Sunny C
 ...
 * @subpackage js
 */
define(['qr-creator', 'WoltLabSuite/Core/Language'], (QrCreator, Language) => {
    'use strict';
    
    /**
     * Renders a QR code for a single table cell.
     *
     * @param {HTMLElement} cell The table cell containing the URL data
     */
