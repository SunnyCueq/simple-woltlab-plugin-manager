 ...
 * 
 * ACP form for creating custom buttons for shortened links. Requires linkID
 * parameter from URL query. Provides form fields for target URL, title, and
 * sort order. Uses WoltLab's FormBuilder API.
 *
 * @author      Sunny C
