...
EOF
    ...
    local temp_file=$(mktemp)
    {
        ...
        if [ "$has_breaking_changes" = "true" ]; then
            ...
            echo ""
            echo "- **WICHTIG:** Bitte Breaking Changes hier dokumentieren"
            echo ""
        fi
        echo "### Added"
        echo ""
        echo "- Neue Features und Verbesserungen"
        echo ""
        echo "### Changed"
        echo ""
        echo "- Änderungen und Updates"
        echo ""
        echo "### Fixed"
        echo ""
        echo "- Bugfixes und Korrekturen"
        echo ""
        echo "### Deprecated"
        echo ""
        echo "- Veraltete Features (falls vorhanden)"
        echo ""
        echo "### Removed"
        echo ""
        echo "- Entfernte Features (falls vorhanden)"
        echo ""
        echo "### Security"
        echo ""
        echo "- Sicherheits-Updates (falls vorhanden)"
        echo ""
        echo "---"
        echo ""
