...
- WoltLab Core
- Erstellt .env Datei
- Initialisiert DDEV-Projekt

### Manuelle Installation

Siehe [Haupt-README.md](../../README.md) für detaillierte Installationsanleitung.
...
cd ~/Dokumente/woltlab-development/tools/woltlab-dev
./start.sh
```
...
- **WoltLab Root:** `/home/benny/Dokumente/woltlab-development/tools/woltlab-dev/public/`
- **Plugin-Entwicklung:** `/home/benny/Dokumente/woltlab-development/basis-plugin/`
- **Plugin-Installation:** `/home/benny/Dokumente/woltlab-development/tools/woltlab-dev/public/shrinkr/`
- **Logs:** `/home/benny/Dokumente/woltlab-development/tools/woltlab-dev/public/log/`

## 📦 Plugin-Installation

1. Plugin bauen:
   ```bash
   cd ~/Dokumente/woltlab-development/basis-plugin
   ./build.sh
   ```
