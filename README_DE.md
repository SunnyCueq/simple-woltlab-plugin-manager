...
### Professionelles Toolkit für WoltLab Suite Plugin-Entwicklung

[![Lizenz](https://img.shields.io/badge/lizenz-MIT-green.svg)](LICENSE)
[![WoltLab](https://img.shields.io/badge/WoltLab-6.0%20%7C%206.1%20%7C%206.2-red.svg)](https://www.woltlab.com)
[![Plattform](https://img.shields.io/badge/plattform-Linux%20%7C%20macOS%20%7C%20WSL2-lightgrey.svg)](#️-unterstützte-plattformen)

**🌍 Sprache / Language:** [🇩🇪 Deutsch](#) | [🇬🇧 English](README.md) | [⚙️ Advanced](docs/README_ADVANCED.md)

[Features](#-was-kann-das-toolkit) • [Schnellstart](#-schnellstart-4-einfache-schritte) • [Dokumentation](#-dokumentation) • [Scripts](#️-scripts) • [Support](#-hilfe--support)
...
Dieses Toolkit funktioniert auf allen gängigen Plattformen:

- ✅ **Linux** - Arch, CachyOS, Ubuntu, Debian, Fedora, etc.
- ✅ **macOS** - Intel & Apple Silicon (M1/M2/M3)
- ✅ **Windows** - WSL2 (Ubuntu 20.04, 22.04, 24.04)

Alle Plattformen werden regelmäßig getestet, um Kompatibilität sicherzustellen.
...
**📖 Vollständige Scripts-Dokumentation:** [scripts/README.md](scripts/README.md)
